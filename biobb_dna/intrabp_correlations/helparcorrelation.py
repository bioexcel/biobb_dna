...
class HelParCorrelation():
    ...
    Examples:
        This is a use example of how to use the building block from Python::
            ...
            from biobb_dna.intrabp_correlations.helparcorrelation import helparcorrelation
    ...
    @launchlogger
    def launch(self) -> int:
        """Execute the :class:`HelParCorrelation <helparcorrelation.helparcorrelation.HelParCorrelation>` object."""
...
def helparcorrelation(
    ...
    """Create :class:`HelParCorrelation <intrabp_correlations.helparcorrelation.HelParCorrelation>` class and
    execute the :meth:`launch() <intrabp_correlations.helparcorrelation.HelParCorrelation.launch>` method."""
