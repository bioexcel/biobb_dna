...
class IntraBasePairCorrelation():
    ...
    @launchlogger
    def launch(self) -> int:
        """Execute the :class:`HelParCorrelation <correlations.intrabasepaircorrelation.IntraBasePairCorrelation>` object."""
...
def intrabasepaircorrelation(
    ...
    """Create :class:`HelParCorrelation <correlations.IntraBasePairCorrelation.IntraBasePairCorrelation>` class and
    execute the :meth:`launch() <correlations.IntraBasePairCorrelation.IntraBasePairCorrelation.launch>` method."""
