...
class BasePairCorrelation():
    """
    | biobb_dna BasePairCorrelation
    ...
    Args:
        ...
        properties (dict):
            * **sequence** (*str*) - Nucleic acid sequence for the input .ser file. Length of sequence is expected to be the same as the total number of columns in the .ser file, minus the index column (even if later on a subset of columns is selected with the *seqpos* option).
    ...
    Examples:
        This is a use example of how to use the building block from Python::
            ...
            from biobb_dna.intrabp_correlations.basepaircorrelation import basepaircorrelation
    ...
    @launchlogger
    def launch(self) -> int:
        """Execute the :class:`HelParCorrelation <correlations.basepaircorrelation.BasePairCorrelation>` object."""
...
def basepaircorrelation(
    ...
    """Create :class:`HelParCorrelation <correlations.BasePairCorrelation.BasePairCorrelation>` class and
    execute the :meth:`launch() <correlations.BasePairCorrelation.BasePairCorrelation.launch>` method."""

    return BasePairCorrelation(
        input_filename_shear=input_filename_shear,
        input_filename_stretch=input_filename_stretch,
        input_filename_stagger=input_filename_stagger,
        input_filename_buckle=input_filename_buckle,
