...
class SequenceCorrelation():
    ...
    Args:
        input_ser_path (str): Path to .ser file with data for single helical parameter. File type: input. Accepted formats: ser
...
def sequencecorrelation(
        input_ser_path: str,
        output_csv_path: str, output_jpg_path: str,
        properties: dict = None, **kwargs) -> int:
    """Create :class:`HelParCorrelation <correlations.sequencecorrelation.SequenceCorrelation>` class and
    execute the :meth:`launch() <correlations.sequencecorrelation.SequenceCorrelation.launch>` method."""

    return SequenceCorrelation(
        input_ser_path=input_ser_path,
        output_csv_path=output_csv_path,
        output_jpg_path=output_jpg_path,
